...
I opted to use pillow PIL for all operations to keep performance fast and avoid numpy calculations and conversions.
"""
...
def get_bg_color(img, use_edge=True, debug = False):
    """
    ====================================================================================================================
    ...
    if not use_edge:  # use full image or when it didn't find anything in the edge
        for count, v in all_colors:
            a = v[-1]
            if a >= 128:
                if debug:
...
def get_default_presets(preset_name, debug=False):
    """
    get settings for default presets
    ====================================================================================================================
    """
    preset_dict = dict()
    ...
    elif preset_name == 'Fill Content Proportionally' or preset_name == 5:
        preset_dict['debug'] = False

    elif preset_name == 'Fill Frame Proportionally' or preset_name == 6:
        preset_dict['debug'] = False
...
if __name__ == '__main__':
    ...
    ====================================================================================================================
    """
    path = r"C:\Users\%USERNAME\Downloads\paint.jpg"
    img = Image.open(path)
    w, h = img.size
